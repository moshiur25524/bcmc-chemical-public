...
const Blogs = () => {
    return (
        <div className='mx-5'>
            ...
            <p className='mb-8'>There are four types of state to manage a state in a react application.They are explained below:
                <br />
            ...
            <p  className='mb-8'>
                I do not set the state directly in react cause, mutating state directly can create a bad bug in code. And some complex componenet can be hard to optimize it.
                A common way to tune a react component is to make the component pure
            </p>
            ...
            <p className='mb-8'>
                let, we have an array of objects. and if we want the name from all objects, we just have to map on the array.
                Example below.
                <br />
                **To get the name property form the object -
                products.map(p ={'>'} <ul>
                    <li>p.name</li>
                </ul>)
            </p>
